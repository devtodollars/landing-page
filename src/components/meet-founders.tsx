const founder = {
  ...
  bio: "A passionate software developer with extensive industry and freelance experience, Amirali has successfully scoped and built numerous MVPs. He is currently working full-time on DevToDollars.",
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            A technical founder with a track record of building and shipping
        ...
        <div className="mx-auto mt-20 max-w-2xl">
          <div className="flex flex-col items-center gap-6 sm:flex-row sm:items-start">
            ...
            <div className="flex-auto text-center sm:text-left">
              ...
              <div className="mt-6 flex gap-x-6 justify-center sm:justify-start">
                {founder.xUrl && (
                  <a
                    href={founder.xUrl}
          ...
          <p className="mt-12 text-sm text-gray-500 text-center">
            The boilerplate was originally created by{" "}
            <a
            ...
            , former CTO of a YC-backed startup.
          </p>
        </div>
      </div>
    </div>
